...
import com.base.view.LinearDot;
...
public abstract class BaseGuideActivity extends AbstractBaseActivity {
    ...
    protected void initBaseView(View view) {
        ...
        ViewPagerAdapter zViewPagerAdapter = new ViewPagerAdapter(viewList);
        ...
        tvSkip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                WrapperSharedPreferences.getInstance(BaseGuideActivity.this).putBoolean(Const.FIRST_LAUNCH, false);
                onTVSkipClick();
            }
        });
        if (isAutoPlay()) {
