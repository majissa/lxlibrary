...
import com.base.R;
import com.base.interfaces.FlowIndicator;
...
/**
 * A horizontally scrollable {@link android.view} with items populated from an
...
public class ViewFlow extends AdapterView<Adapter> {
    ...
    private boolean scrolled = false;//默认一张的时候不要滑动
    ...
    public void startAutoFlowTimer() {
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (handler != null) {
                    if (mAdapter != null && mSideBuffer > 1) {//只有当页面大于1页的时候才可以自动轮播
...
//                getParent().requestDisallowInterceptTouchEvent(true);
                ...
                if (xMoved) {
                    ...
                    if (mAdapter != null && mSideBuffer > 1) {
