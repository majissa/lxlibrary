...
public class MarqueeView extends LinearLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        WrapperLog.v(TAG, "onLayout called!" + "changed: " + changed);
    ...
    public void startMarquee() {
        WrapperLog.v(TAG, "startMarquee called");
    ...
    private void initView(Context context) {
        ...
        mTextField.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                ...
                WrapperLog.v(TAG, "afterTextChanged called");
...
//                    stringOfItem = str + interval;
                    ...
                    WrapperLog.v(TAG, "string of TextView deal ok!###");
                    WrapperLog.v(TAG, "lengthOfll: " + getMeasuredWidth() + "###");
                    WrapperLog.v(TAG, "lengthOfTextView: " + widthOfTextView
                            + "###");
                    WrapperLog.v(TAG, "CONTENT: " + stringOfTextView + "###");
                    // 设置起始
