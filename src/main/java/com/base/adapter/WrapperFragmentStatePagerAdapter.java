 ...
 * 创建日期：2013-05-19
 * <p/>
 * 描述 :WrapperFragmentStatePagerAdapter 和前面的 FragmentPagerAdapter 一样，
 ...
 * **********************************************************
 */
public class WrapperFragmentStatePagerAdapter extends FragmentStatePagerAdapter {

    private List<Fragment> fragmentList = new ArrayList<>();
    private List<String> titleList = new ArrayList<>();

    public WrapperFragmentStatePagerAdapter(FragmentManager fragmentManager, List<Fragment> fragmentList) {
