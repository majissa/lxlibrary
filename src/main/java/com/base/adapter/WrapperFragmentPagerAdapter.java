 ...
 * **********************************************************
 */
public class WrapperFragmentPagerAdapter extends FragmentPagerAdapter {

    private List<Fragment> fragmentList = new ArrayList<>();
    private List<String> titleList = new ArrayList<>();

    public WrapperFragmentPagerAdapter(FragmentManager fragmentManager, List<Fragment> fragmentList) {
